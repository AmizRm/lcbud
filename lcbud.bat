...
echo   2) Download Lunar Launcher Inject
echo   3) Download Weave Loader
echo   4) Download Agents / Mods
echo   5) Download Utilities
echo   6) Download JREs
::echo   8) Downgrade Lunar Client Launcher to 2.16.1
echo   7) Backup multiver
echo   -------------------------------------------
echo  8) View Credits
echo  9) View License
echo  10) Exit
...
set "applicationData[2]=https://github.com/Nilsen84/lunar-launcher-inject/releases/download/v1.3.0/lunar-launcher-inject-windows-1.3.0.exe lunar-launcher-inject.exe"
set "applicationData[3]=https://github.com/Weave-MC/Weave-Loader/releases/download/v0.2.6/Weave-Loader-Agent-0.2.6.jar Weave-Loader-Agent-0.2.6.jar"
...
if "%input%"=="4" goto :am
if "%input%"=="5" goto :utilities
if "%input%"=="6" goto :jres
::if "%input%"=="8" goto :lcd
if "%input%"=="7" goto :multiver
if "%input%"=="8" goto :credits
if "%input%"=="9" goto :licenses
if "%input%"=="10" exit /b
goto :menu
...
echo   3) Crepes - Display MinecraftCapes users' capes in-game. (ZenithCore Required)
echo   4) Dulikk - Custom View Model
echo   5) GTB Solver - Guess the builder solver.
echo   6) Hu Tao - Draw a dancing Hu Tao on your screen.
echo   7) Inclumsy - Spoof your ping.
echo   8) InventorySnow - snow in your inventory
echo  9) MMUtils - Hypixel Murder Mystery Utilities.
echo  10) Name History - Check a user's name history with a command.
echo  11) OofMod - Play a customizable sound during in-game events.
echo  12) OuchMod - A Weave Mod for Lunar Client that says "ouch" in chat every time you take damage.
echo  13) PitUtils - Hypixel Pit Utilities.
echo  14) Weave Mod that asynchronously polls mouse input
echo  15) VanillaMenu - Bring back the vanilla Minecraft main menu.
echo  16) ViaLunar - Join 1.9+ servers from LunarClient 1.8 (ZenithCore Required)
echo  17) WeaveChamsMod - Render players over blocks, see players through walls!
echo  18) Weave Optifine URL - Specify a new URL for the Optifine cape server.
echo  19) WeaveQuickReport - quickreport mod rewritten for Weave. Also comes with autododge.
echo  20) WPK - A Weave mod implementation of MPKMod 2 mod.
echo  21) ZenithCore - Dependency for mods.
echo   -------------------------------------------
echo  22) Cheats
echo  23) Go Back
echo.
...
set "modData[1]=https://gitlab.com/candicey-weave/autocorrect/-/package_files/96942525/download AutoCorrect-0.1.0-relocated.jar"
...
set "modData[3]=https://gitlab.com/candicey-weave/crepes/-/package_files/96402668/download Crepes-0.2.2-relocated.jar"
set "modData[4]=https://gitlab.com/candicey-weave/dulikk/-/package_files/108625584/download Dulikk-0.2.4-relocated.jar"
set "modData[5]=https://gitlab.com/candicey-weave/gtb-solver/uploads/d1288dbce390dbe7d98cfc1f406750fd/GTB-Solver-0.1.0.jar GTB-Solver.jar"
set "modData[6]=https://github.com/Ultramicroscope/HuTao/releases/download/v1.1/HuTao-1.0.jar HuTao.jar"
set "modData[7]=https://codeberg.org/Candicey-Weave/Inclumsy/releases/download/v0.1.0/Inclumsy-0.1.0.jar Inclumsy.jar"
set "modData[8]=https://github.com/Tryflle/InventorySnow/releases/download/1.1-Compatibility-fix/InvSnow-1.1.jar InvSnow.jar"
set "modData[9]=https://github.com/Yan-Jobs/mm-utils/releases/download/v1/MMUtils-1.0.jar MMUtils.jar"
set "modData[10]=https://github.com/Ultramicroscope/NameHistory/releases/download/weave-1.0.1/NameHistory-1.0.1.jar NameHistory.jar"
set "modData[11]=https://github.com/thaYt/oofmod/releases/download/v1.0/OofMod-1.0.jar OofMod.jar"
set "modData[12]=https://github.com/gabswastaken/OuchMod/releases/download/ouch/OuchMod-1.0.jar OuchMod.jar"
set "modData[13]=https://github.com/supercoolspy/PitUtilsLunar/releases/download/1.2.0/PitUtils-1.2.0.jar PitUtils.jar"
set "modData[14]=https://github.com/770grappenmaker/AsyncRawInput/releases/download/v0.1/async-raw-input-0.1-mapped.jar async-raw-input-0.1-mapped.jar"
set "modData[15]=https://github.com/Zxnii/VanillaMenu/releases/download/v3.0.0/VanillaMenu-3.0.0.jar VanillaMenu.jar"
set "modData[16]=https://gitlab.com/candicey-weave/viaversion-lunar/uploads/9ba371b7abc07e0958ec559a9d9f0a30/ViaLunar-3.0.0.jar ViaLunar.jar"
set "modData[17]=https://github.com/Tryflle/WeaveChamsMod/releases/download/1.1-Release/WeaveChamsMod-1.1.jar WeaveChamsMod.jar"
set "modData[18]=https://github.com/770grappenmaker/weave-optifine-url/releases/download/v0.2/weave-optifine-url-0.2.jar weave-optifine-url.jar"
set "modData[19]=https://github.com/Tryflle/WeaveQuickReport/releases/download/1.1/WeaveQuickReport-1.1.jar WeaveQuickReport.jar"
set "modData[20]=https://gitlab.com/candicey-weave/wpk/-/package_files/105228232/download wpk.jar"
set "modData[21]=https://gitlab.com/candicey-weave/zenith-core/-/package_files/129935193/download Zenith-Core.jar"
...
if /i "%mods%"=="22" goto :modscheats
if /i "%mods%"=="23" goto :am
goto :mods
...
echo   1) Legit-ish [40;31m(Cheating Client)[40;37m
echo   2) NoHitDelay NoHitDelay for Lunar Client using Weave
echo   3) RavenWeave [40;31m(Cheating Client[40;37m, ZenithCore Required)
echo   4) RavenWeaveLite [40;31m(Cheating Client)[40;37m
echo   -------------------------------------------
echo   5) Go Back
echo.
...
set "cheatData[1]=https://github.com/legitish/Legit-ish-Weave/releases/download/latest/legitish-2.0.0.jar Legit-ish"
set "cheatData[2]=https://github.com/Nilsen84/WeaveNoHitDelay/releases/download/v2.0/WeaveNoHitDelay-2.0.jar NoHitDelay"
set "cheatData[3]=https://github.com/PianoPenguin471/RavenWeave/releases/download/1.1.4/RavenWeave-1.1.4.jar RavenWeave"
set "cheatData[4]=https://github.com/PianoPenguin471/RavenWeaveLite/releases/download/bugfix/RavenWeaveLite-1.0.jar RavenWeaveLite"
...
set "utilityData[1]=https://github.com/jagt/clumsy/releases/download/0.3/clumsy-0.3-win64-a.zip clumsy.zip"
...
if "%jres%"=="1" set "jreName=GraalVM" & set "jreFolder=graalvm-jdk22" & set "jreZip=graalvm-jdk22.zip" & set "jreDownloadUrl=https://download.oracle.com/graalvm/22/latest/graalvm-jdk-22_windows-x64_bin.zip"
if "%jres%"=="2" set "jreName=Zulu" & set "jreFolder=zulu-jre22" & set "jreZip=zulu-jre22.zip" & set "jreDownloadUrl=https://cdn.azul.com/zulu/bin/zulu22.30.13-ca-jre22.0.1-win_x64.zip"
if "%jres%"=="3" goto :menu
